    ...
    <div class="decor-card revealed" style="opacity:1 !important; transform:none !important;" data-id="${item.id}">
      ...
      <div class="decor-card-body">
        ...
        <div class="decor-card-footer">
          ...
          <button class="btn btn-primary btn-sm btn-add-bag btn-add-cart" data-id="${item.id}"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" width="14" height="14" style="display:inline-block; vertical-align:middle; margin-right:3px;"><circle cx="9" cy="21" r="1"></circle><circle cx="20" cy="21" r="1"></circle><path d="M1 1h4l2.68 13.39a2 2 0 0 0 2 1.61h9.72a2 2 0 0 0 2-1.61L23 6H6"></path></svg> <span>Add Cart</span></button>
        </div>
      </div>
    </div>`;
  }
